...
def main():
    ...
    input_image_path = 'tests/test9.jpg'
    ...
    # Instanciate the TensorRT engine
    ...
    bboxes = process_outputs(trt_outputs, num_classes, resolution_raw, input_shape, 0.3)
    bbox = bboxes[0]
    ...
    #image = utils.draw_bbox(original_image, bboxes, classes=all_classes)
